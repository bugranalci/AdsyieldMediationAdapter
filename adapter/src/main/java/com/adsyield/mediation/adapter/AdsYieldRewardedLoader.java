...
public class AdsYieldRewardedLoader implements MediationRewardedAd {
    ...
    public void loadAd() {
        ...
        Log.d(AdsYieldAdapter.TAG, "Loading rewarded ad with ad unit ID: " + adUnitId);

        RewardedAd.load(context, adUnitId, new AdRequest.Builder().build(),
                new RewardedAdLoadCallback() {
                    @Override
                    public void onAdLoaded(@NonNull RewardedAd ad) {
                        Log.d(AdsYieldAdapter.TAG, "Rewarded ad loaded successfully.");
                        rewardedAd = ad;
                        rewardedAdCallback = mediationAdLoadCallback.onSuccess(AdsYieldRewardedLoader.this);
                        ...
                        ad.setFullScreenContentCallback(new FullScreenContentCallback() {
                            ...
                            public void onAdFailedToShowFullScreenContent(@NonNull AdError adError) {
                                Log.e(AdsYieldAdapter.TAG, "Rewarded ad failed to show: " + adError.getMessage());
                            }
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        Log.e(AdsYieldAdapter.TAG, "Rewarded ad failed to load: " + loadAdError.getMessage());
